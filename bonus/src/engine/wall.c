...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/30 14:48:53 by llaruell          #+#    #+#             */
/*   Updated: 2022/12/30 14:49:13 by llaruell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	get_texture_y(t_game *game, t_raycast *ray, t_tex *tex)
{
		...
		&& i < game->win.height)
	{
		...
		color = shader(ray->perp_wall_dist / 1.5,
				get_color_tex(tex), game->control.shade);
